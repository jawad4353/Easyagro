...
import '../Company/companyhome.dart';
...
class update_dealer_account extends StatefulWidget{
  var user_data=[];
  update_dealer_account({required this.user_data});
  @override
  State<update_dealer_account> createState() => _update_dealer_accountState();
}

class _update_dealer_accountState extends State<update_dealer_account> {
        ...
        body: ListView(children: [
          ...
          Padding(
            ...
            child: ElevatedButton(style: ButtonStyle(
              ...
              duplicate_email=await new database().Duplicate_email_updation(email_controller.text,'dealer',widget.user_data[4]);
              ...
              Navigator.push(context, Myroute(OTP_screen(Data: new_data,type: 'update_profile_dealer',OTP:OTP ,)));
